    ...
    <AppBar position="static">
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          >
            Foodieland<span style={{color : '#FF7426'}}>.</span>
          </Typography>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex', justifyContent: 'center', position: 'relative', left: '210px'} }}>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'flex', justifyContent: 'right', position: 'relative', right: '40px'} }}>
